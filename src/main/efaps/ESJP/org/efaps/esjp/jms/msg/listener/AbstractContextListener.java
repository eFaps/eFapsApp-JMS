    ...
    implements MessageListener
{
     ...
     */
    protected static final Logger LOG = LoggerFactory.getLogger(AbstractContextListener.class);

    @Override
    public void onMessage(final Message _msg)
    {
        try {
            String sessionKey = _msg.getStringProperty(AbstractContextListener.SESSIONKEY_PROPNAME);
            if (sessionKey == null) {
        ...
        if (replyto instanceof  Queue) {
            ...
            if (def != null) {
                ...
                if (_sessionKey == null) {
                    ...
                    msg.setStringProperty(AbstractContextListener.SESSIONKEY_PROPNAME, _sessionKey);
                }
